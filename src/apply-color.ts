...
export async function unapplyColors() {
  ...
  // Snapshot the workspace config BEFORE deletePeacocksColorCustomizations runs —
  // it mutates the underlying object in place, so we need a copy to compare against
  // for the equality check below.
